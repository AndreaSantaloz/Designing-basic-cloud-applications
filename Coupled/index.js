...
app.get('/', (req, res) => {
    res.json({ 
        message: 'API funcionando en ECS + NLB con DynamoDB',
...
app.get('/health', (req, res) => {
    res.json({ 
        status: 'OK', 
        message: 'ECS funcionando correctamente',
        environment: 'ECS + NLB + API Gateway + DynamoDB',
        table: TABLE_NAME
    });
});
...
// INICIO DEL SERVIDOR (SOLO para ECS)
const PORT = process.env.PORT || 8080;
app.listen(PORT, '0.0.0.0', () => {
    console.log(`Servidor ECS ejecutándose en puerto ${PORT}`);
